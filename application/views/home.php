...
<html lang="en">
  <head>
    ...
    <!-- Author Meta -->
    <meta name="author" content="Dian Ratnawati">
    <!-- Meta Description -->
    <meta name="description" content="Curriculum Vitae Dian Ratnawati">
    <!-- Meta Keyword -->
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
              <div class="contents">
                ...
                <?php
                $str = "https://wa.me/6281231191604?text=Hallo *Dianratna*, Saya tertarik dengan CV kamu.";
